...
This uses eglot for annotations and hints. It's more lightweight than the full scale Golang LSP. Important to not that this requires `gopls` to be installed.
